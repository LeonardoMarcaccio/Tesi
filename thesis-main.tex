...
I              \caption{Rappresentazione schematica del prototipo}
    ...
    \section{Sviluppo}
        ...
        \subsection{Realizzazione del Btree}
            ...
            \lstinputlisting[float,language=csh,label={lst:NodePageChildSection}]{listings/NodePageChildSection.cs}

            \lstinputlisting[float,language=Java,label={lst:NodePageEntrySection}]{listings/NodePageEntrySection.cs}
            ...
            \subsection{Sviluppo della EntryPage}
                ...
                \lstinputlisting[float,language=csh,label={lst:random-code}]{listings/EntryPage.cs}
            ...
            \subsection{Sviluppo della classe BTree}
                ...
                \paragraph{Creazione degli Elementi del BTree}
                    ...
                    \lstinputlisting[float,language=csh,label={lst:BTreeElementsCreation}]{listings/BTreeElementsCreation.cs}
                ...
                \paragraph{Metodi per l'inserimento nel BTree}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeInsert}]{listings/BTreeInsert.cs}
                ...
                \paragraph{Metodi per la rimozione nel BTree}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeDelete}]{listings/BTreeDelete.cs}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeDeleteInternal}]{listings/BTreeDeleteInternal.cs}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeDeleteKeyFromNode}]{listings/BTreeDeleteKeyFromNode.cs}
                ...
                \paragraph{Metodi per la ricerca e lo split nel BTree}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeSearch}]{listings/BTreeSearch.cs}
