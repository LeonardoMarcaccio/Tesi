...
\begin{abstract}
    Questa Tesi esplora il processo di studio, progettazione e implementazione di un prototipo di \textit{\ac{FS}} basato sulla struttura dati \textit{B-Tree}, sviluppato per la piattaforma \textit{\ac{IoT}} IOtto di Onit S.p.A.
...
I              \caption{Rappresentazione schematica del prototipo}
    ...
    \section{Sviluppo}
        ...
        \subsection{Realizzazione del Btree}
            ...
            \subsubsection{Sviluppo della classe BTree}
                ...
                \paragraph{Metodi per la rimozione nel BTree}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeDelete}]{listings/BTree/BTreeDelete.cs}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeDeleteInternal}]{listings/BTree/BTreeDeleteInternal.cs}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeDeleteKeyFromNode}]{listings/BTree/BTreeDeleteKeyFromNode.cs}
                ...
                \paragraph{Metodi per la ricerca nel BTree}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeSearch}]{listings/BTree/BTreeSearch.cs}
                ...
                \paragraph{Metodi di Utility del BTree}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeSplit}]{listings/BTree/BTreeSplit.cs}
                ...
                \paragraph{Metodi di Serializzazione e Deserializzazione del BTree}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeSerialize}]{listings/BTree/BTreeSerialize.cs}
                    ...
                    \lstinputlisting[float,language=csh,label={BTreeDeserialize}]{listings/BTree/BTreeDeserialize.cs}
        ...
        \subsection{Sviluppo dei Test}
            ...
            \lstinputlisting[float,language=csh,label={lst:ValidateTree}]{listings/Test/ValidateTree.cs}
